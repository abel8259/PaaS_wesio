...
<div class="row">
    <div class="col-sm-3">
      <a href="../profile/home/" class="btn btn-danger  btn-block btn-compose-email"> voltar </a>
       ...
       <a href="../gerent/send/" class="btn btn-danger  btn-block btn-compose-email"> investir em ideia </a>
...
<?php
 ...
 $sql=$pdo->prepare("SELECT * FROM env_profile5 ;");
...
?>
 ...
 $sql=$pdo->prepare("SELECT * FROM sub_repo_0z  ");
    ...
    foreach ($info as $key => $value ){
      ...
      echo "<a href='#'>";
      echo"<i class='fa fa-folder-open'></i>".$value['name'];
...
?>
 ...
 $sql=$pdo->prepare("SELECT * FROM env_profile5 ORDER BY id desc LIMIT 1;");
