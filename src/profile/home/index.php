...
<div class="row">
    <div class="col-sm-3">
        <a href="../../switch/" class="btn btn-danger  btn-block btn-compose-email"> voltar </a>
       <a href="../../../con/" class="btn btn-danger  btn-block btn-compose-email"> sair  </a>
        
        <ul class="nav nav-pills nav-stacked nav-email shadow mb-20">
           
            <li>
                <a href="../send/"><i class="fa fa-envelope-o"></i> A enviar -- Trabalhos</a>
            </li>
            <li>
                <a href="../important"><i class="fa fa-certificate"></i>  Marcações importantes </a>
            </li>
            <li>
                <a href="../drafts">
                    <i class="fa fa-file-text-o"></i> Rascunhos 
                </a>
            </li>
            <li>
                <a href="../inbox">
                    <i class="fa fa-file-text-o"></i> commit & backups  
                </a>
            </li>
            <li><a href="../trash/ "> <i class="fa fa-trash-o"></i> Lixo --Recognize</a></li>
        </ul><!-- /.nav -->

       
        <h5 class="nav-email-subtitle">Sistema digital:</h5>
   ...
   <h5 class="nav-email-subtitle">Mini-localidade:</h5>
...
include('../../../con/conexao.php');
 ...
 $sql=$pdo->prepare("SELECT * FROM mini_loc_0t  ");
    ...
    foreach ($info as $key => $value ){
      ...
      echo "<a href='#' class='btn btn-danger  btn-block btn-compose-email'>";
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                        ...
                        <div class="col-xs-12 col-sm-8">
                           <ul class="list-group">
                              <li class="list-group-item"><i class="fa fa-folder-open"></i> LAST  draft  </li>
                              <li class="list-group-item"><i class="fa fa-folder-open"></i> LAST   important </li>
                              <li class="list-group-item"><i class="fa fa-folder-open"></i> LAST  inbox  </li>
                              <li class="list-group-item"><i class="fa fa-folder-open"></i> DELETE  </li>
                              <li class="list-group-item"><i class="fa fa-folder-open"></i> SEND  investimento </li>
                              <li class="list-group-item"><i class="fa fa-folder-open"></i> LAST  investimento: </li>
                           </ul>
                        </div>
                     </div>
                  </div>
